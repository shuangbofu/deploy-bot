...
import type { PageResult, ProjectConnectionTestResult, ProjectPayload, ProjectSummary } from './types';
...
export const projectsApi = {
  ...
  listPage: async (params: { page: number; pageSize: number; keyword?: string; gitAuthType?: string }) =>
    (await client.get<PageResult<ProjectSummary>>('/projects/page', { params })).data,
