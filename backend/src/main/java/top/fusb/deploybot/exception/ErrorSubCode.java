...
public enum ErrorSubCode {
    ...
    RUNNING_DEPLOYMENT_CANNOT_ROLLBACK("BIZ-DEPLOYMENT-001", "执行中的部署不能直接回滚，请先等待结束或停止任务。", ErrorCode.OPERATION_NOT_ALLOWED),
    DEPLOYMENT_ARTIFACT_MISSING("BIZ-DEPLOYMENT-002", "这条部署记录没有可复用的构建产物，暂时无法重新发布。", ErrorCode.OPERATION_NOT_ALLOWED),
