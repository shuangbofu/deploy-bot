...
public interface NotificationDeliveryRecordRepository extends JpaRepository<NotificationDeliveryRecordEntity, Long>, JpaSpecificationExecutor<NotificationDeliveryRecordEntity> {
