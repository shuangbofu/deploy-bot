...
public class SchemaMigrationBootstrap {
    ...
    public void migrate() {
        List<String> statements = List.of(
                ...
                "CREATE TABLE IF NOT EXISTS api_tokens (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, name VARCHAR(100) NOT NULL, token_hash VARCHAR(64) NOT NULL, token_prefix VARCHAR(32) NOT NULL, user_id BIGINT NOT NULL, scopes_json CLOB, expires_at TIMESTAMP, last_used_at TIMESTAMP, last_used_ip VARCHAR(100), enabled BOOLEAN NOT NULL, created_at TIMESTAMP NOT NULL, revoked_at TIMESTAMP)",
                "CREATE UNIQUE INDEX IF NOT EXISTS uk_api_tokens_token_hash ON api_tokens(token_hash)",
